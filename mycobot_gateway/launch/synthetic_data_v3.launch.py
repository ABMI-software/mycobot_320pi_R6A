...
def generate_launch_description():
    ...
    world_path = os.path.join(desc_pkg, 'worlds', 'randomized_v2.sdf')
    ...
    bridge_args = [
        '/world/randomized_v2/model/mycobot_320/joint_state'
    ...
    gz_bridge = Node(
        ...
        remappings=[
            ('/world/randomized_v2/model/mycobot_320/joint_state', '/joint_states'),
        ],
    )
