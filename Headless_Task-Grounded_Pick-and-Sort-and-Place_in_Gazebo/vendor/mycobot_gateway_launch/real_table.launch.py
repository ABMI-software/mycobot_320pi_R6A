...
pick-and-place cycle sorting all 4 objects (red/blue/green/yellow) into
their matching bins, pass demo:=true.
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description='Run one physical sort of all 4 objects into their bins'),
        ...
        Node(
            ...
            parameters=[{
                ...
                'bin_xy.blue_cube': [0.34, 0.13],
                'bin_xy.green_cylinder': [0.34, -0.04],
                'bin_xy.yellow_box': [0.33, -0.17],
            }],
